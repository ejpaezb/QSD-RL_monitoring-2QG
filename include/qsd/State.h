...
// of a particular type.
    ...
    const ImaginaryUnit mIm = MINUS_IMAGINARY_UNIT;
...
// IM/O functions for FreedomType
...
// constructors and destructors
        ...
        // state or displaced Fock state basis, centered at alpha in shaving_phase space.
        // form gives the FreedomType of the State (default is FIELD).
...
// in shaving_phase space.  These wave packets are closely centered on some point
...
// For further details, see J. Phys. A 28, 5401-5413 (1995).
        ...
        // Recenters freedom theFreedom at its expectation value in shaving_phase space.
        ...
        // it moves the basis to a new absolute position alpha in shaving_phase space.
        // Uses moveCoords.
...
// used for greater efficiency in 1 Freedom problems
        ...
        // of the basis states
		std::complex<double> coord;        // center of coordinates in shaving_phase space
...
//   nSkips[m] = n_0*n_1*...*n_(m-1).
		...
		std::vector<std::complex<double>> coords;        // centers of coordinates in shaving_phase space
